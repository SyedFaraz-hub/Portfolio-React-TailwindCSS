    ...
    <footer class="text-center bg-gray-900 text-white">
      <div class=" px-6 pt-6">
        <div class="flex justify-center mb-6">
          <a
            href="https://www.facebook.com/syedfarazfb"
            type="button"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="mailto:farazshah116@gmail.com"
            type="button"
            target="_blank"
            rel="noreferrer"
            class="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          ...
          <a
            href="https://www.instagram.com/farazz_syed/"
            type="button"
            target="_blank"
            rel="noreferrer"
            class="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          ...
          <a
            href="https://www.linkedin.com/in/syedfaraz-link"
            type="button"
            target="_blank"
            rel="noreferrer"
            class="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          ...
          <a
            href="https://github.com/SyedFaraz-hub"
            type="button"
            target="_blank"
            rel="noreferrer"
            class="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
